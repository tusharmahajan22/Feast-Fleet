...
const MainContainer = () => {
  ...
  return (
    ...
    {/* Food delivery logo section */}
       <div className='flex  items-center rounded-full text-xs p-1 px-2  justify-center text-orange-500 font-semibold bg-orange-100 max-w-[130px]'>
        <p>Bike Delivery</p>
       ...
       <motion.p  
       className='py-5 text-4xl lg:text-5xl font-bold md:tracking-[normal] md:py-8 lg:max-w-[500px] '> We offer the <span className='text-orange-500'>Fastest Delivery </span>
        ...
        Restaurant-style Yogurt Mint Sauce is a delightful dip that's quick and easy to make. This classic Indian mint chutney pairs perfectly with crispy naan chips, infused with the refreshing flavors of mint and lemon. Treat your taste buds to pure pleasure 😉..
        </p>
        ...
        className='text-white  text-bold gap-2 p-3 my-8 text-xs cursor-pointer rounded-full bg-orange-500 w-[120px] shadow-lg md:max-w-[140px] max-h-[80px] border-2 border-orange-100 font-bold flex justify-center items-center' href='#popular' >Order Now </motion.a>
        ...
        className='border border-orange-400 text-bold gap-1 text-xs p-3 my-8 cursor-pointer rounded-full  text-orange-500 w-[120px]  sm:max-w-[160px] max-h-[80px]  font-bold flex justify-center items-center hover:bg-gradient-to-t hover:from-slate-50 hover:to-orange-100 shadow-lg'>All Foods <BsArrowRight className='font-bold' /></motion.p>
         </Link>
        <div className='flex justify-center text-xs items-center  p-1 font-bold text-orange-700'>
       ...
       {categories && categories.map(({id , type , image}) => {
        return (
          ...
          <div className='w-[120px] shadow-lg h-[140px] lg:w-[160px] lg:h-[210px] rounded-xl flex-col gap-y-2 flex items-center justify-center bg-gradient-to-r from-slate-200 my-8
           to-orange-200 cursor-pointer hover:border border-orange-300 border drop-shadow hover:bg-gradient-to-r hover:to-pink-200 hover:from-slate-50'>
      ...
      <div className='p-5 sm:p-10 lg:px-28'>
         ...
         className='grid grid-col sm:grid-cols-2 lg:grid-cols-4 my-4'>
           <div className='flex flex-col gap-y-2 justify-center items-center'>
               ...
               <span className='p-2 border-dotted border-2 rounded-full border-orange-300 w-12 h-12 text-center font-bold'>01</span>
           ...
           className='flex flex-col gap-y-2 justify-center items-center'>
               ...
               <span className='p-2 border-dotted border-2 rounded-full border-orange-300 w-12 h-12 text-center font-bold'>02</span>
           ...
           <motion.div
            ...
            className='flex flex-col gap-y-2 justify-center items-center'>
               ...
               <span className='p-2 border-dotted border-2 rounded-full border-orange-300 w-12 h-12 text-center font-bold'>03</span>
           ...
           className='flex flex-col gap-y-2 justify-center items-center'>
               ...
               <span className='p-2 border-dotted border-2 rounded-full border-orange-300 w-12 h-12 flex justify-center  items-center font-bold'>04</span>
